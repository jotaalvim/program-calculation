...
\\[\blanklineskip]%
\>[B]{}\Varid{initial}\mathrel{=}((\mathrm{0},\mathrm{0}),\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{x},\Varid{y}),\Varid{z})\mathrel{=}((\Varid{y},\Varid{z}),\Varid{c}\mathbin{*}\Varid{x}\mathbin{+}\Varid{b}\mathbin{*}\Varid{y}\mathbin{+}\Varid{a}\mathbin{*}\Varid{z}){}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{post}\mathrel{=}\Varid{tail}\comp \map \;\Varid{concat}\comp \Varid{prefixes}\comp \Varid{nodes}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment mete (a,b) = map (a:) b}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment cataExp (inl . (singl -|- mete))}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{quadrado}\;((\Varid{x},\Varid{y}),\Varid{l})\mathrel{=}\beta \;\Varid{t}\mathbin{\$}\beta \;\Varid{a}\;[\mskip1.5mu \Varid{d},\Varid{e},\Varid{c}\mskip1.5mu]\mathbin{+\!\!\!+}\beta \;\Varid{f}\;[\mskip1.5mu \Varid{d},\Varid{c}\mskip1.5mu]\mathbin{+\!\!\!+}\beta \;\Varid{b}\;[\mskip1.5mu \Varid{d},\Varid{e},\Varid{c}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{t}\mathrel{=}\Varid{l}\mathbin{/}\mathrm{3}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{a}\mathrel{=}\Varid{y}\mathbin{+}\Varid{l}\mathbin{+}\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{b}\mathrel{=}\Varid{y}\mathbin{-}\mathrm{2}\mathbin{*}\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{f}\mathrel{=}\Varid{y}\mathbin{+}\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{c}\mathrel{=}\Varid{x}\mathbin{+}\Varid{l}\mathbin{+}\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{d}\mathrel{=}\Varid{x}\mathbin{-}\mathrm{2}\mathbin{*}\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{e}\mathrel{=}\Varid{x}\mathbin{+}\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\beta \mathrel{=}\map \comp \Varid{flip}\;\overline{\Varid{id}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{aplica}\;(\Varid{q},\Varid{n})\mathrel{=}(\Varid{q},\beta \;(\Varid{n}\mathbin{-}\mathrm{1})\;(\Varid{quadrado}\;\Varid{q})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment transforma (a,0) = i1 (a,[])}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment transforma (a,b) = i2 (a,b-1)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gsq}\mathrel{=}\Varid{aplica}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  theta l = do drawSq l >> await}{}\<[E]%
\\
\>[B]{}\theta \mathrel{=}(\sequ \Varid{await})\comp {}\<[23]%
\>[23]{}(\mathbf{do}\;\Varid{drawSq}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment present :: [Square] -> IO [()]}{}\<[E]%
\\
\>[B]{}\Varid{present}\mathrel{=}\bot \mbox{\onelinecomment cataList $ either return) ( theta . p1)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment present = cataList $ either return ( cons . ( theta >< id ) )}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[17]{}\mathrel{=}(\Varid{a},\Varid{b}\mathbin{+}\Varid{d})\mathbin{:}\Varid{e}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{c},\Varid{d}{}\<[25]%
\>[25]{})\mathbin{:}\Varid{insere}\;(\Varid{a},\Varid{b})\;\Varid{e}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cgene}\mathrel{=}\bot \mbox{\onelinecomment  (either nul id) . (id >< (uncurry insere))}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Geração dos jogos da fase de grupos:
\begin{hscode}\SaveRestoreHook
