...
\begin{eqnarray*}
\start
     \ensuremath{\Varid{gene}\mathrel{=}\alt{\Varid{nil}}{\Varid{id}}\comp \Varid{id}\mathbin{+}\uncurry{\Varid{insere}}}
%
\just\equiv{ (22); (1)x2  }
%
     \ensuremath{\Varid{gene}\mathrel{=}\alt{\Varid{nil}}{\uncurry{\Varid{insere}}}}
\qed
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment post = tail . map concat . prefixes . nodes}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment post = cataExp $ either (singl . singl) $ mete . (id >< concat)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  ver claculo pela imagem}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment constructSierp5 = do }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     drawSq (sierpinski (((0, 0), 32), 0))}{}\<[E]%
\\[\blanklineskip]%
...
\>[6]{}\Varid{return}\;(){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment theta = (>> await) . (drawSq)}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{present2}\mathrel{=}\llparenthesis\, \cdot \,\rrparenthesis\mathbin{\$}\alt{\Varid{return}}{\theta \comp \p1}{}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment consolidate' [('a',3), ('b',5), ('b',10), ('c',10), ('a',99)]}{}\<[E]%
\\[\blanklineskip]%
