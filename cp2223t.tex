...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment fbl a b c = wrap · for (loop a b c) initial}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  FIXME começa no segundo termo}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{initial}\mathrel{=}((\mathrm{0},\mathrm{1}),\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment arvore [x] = Var x}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment arvore l   = Term (Var a) filhos}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     where (a,b)  = splitp l}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment           filhos = [arvore f p f <- b]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  arvore = uncurry Term . (Var >< (map arvore)) . splitp}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment splitp (a:l) = (a , groupBy (\_ y -> ce y > γ )  l )}{}\<[E]%
\\
\>[B]{}\Varid{splitp}\;(\Varid{a},\Varid{l})\mathrel{=}(\Varid{a},\Varid{groupBy}\;\underline{(\mathbin{>}\Varid{γ})\comp \Varid{ce}}\;\Varid{l})\;{}\<[54]%
\>[54]{}\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{γ}{}\<[8]%
\>[8]{}\mathrel{=}\Varid{ce}\;\Varid{a}\mathbin{+}\mathrm{4}\mbox{\onelinecomment  indentação do pai + 4}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{ce}\mathrel{=}\Varid{anaNat}\;\Varid{ψ}\mbox{\onelinecomment  conta espaços}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{ψ}\;(\text{\ttfamily '~'}\mathbin{:}\Varid{t})\mathrel{=}i_2\;\Varid{t}{}\<[E]%
\\
\>[B]{}\Varid{ψ}\;\anonymous \mathrel{=}i_1\;(){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\mbox{\onelinecomment cataExp (inl . (singl -