...
\begin{eqnarray}
\ensuremath{\begin{lcbr}\\\cdot \\\cdot \end{lcbr}}lcbr
      (f 0 = 1)
...
\ensuremath{\begin{lcbr}\Varid{f}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \mathrm{1},\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))\comp \Varid{loop}\mskip1.5mu]\\\Varid{g}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \mathrm{1},\p1\comp \p1\comp \Varid{loop}\mskip1.5mu]\\\Varid{h}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{zero},\p2\comp \p1\mskip1.5mu]\end{lcbr}}
     
     
\ensuremath{\begin{lcbr}\mathbin{<}\Varid{f}\comp \mathbf{in}\;,\Varid{g}\comp \mathbf{in}\mathbin{>}\mathrel{=}\mathbin{<}[\mskip1.5mu \Varid{one},\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))\comp \Varid{loop}\mskip1.5mu],[\mskip1.5mu \Varid{one},\p1\comp \p1\comp \Varid{loop}\mskip1.5mu]\mathbin{>}\\\cdot \end{lcbr}}
...
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{n}{}\<[10]%
\>[10]{}\mathbin{>}\mathrm{0}\mathrel{=}(\Varid{meio},\Varid{lista}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{a}\equiv \Varid{c}{}\<[17]%
\>[17]{}\mathrel{=}(\Varid{a},\Varid{b}\mathbin{+}\Varid{d})\mathbin{:}\Varid{e}\mbox{\onelinecomment  insere (a,b) e }{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{otherwise}\mathrel{=}(\Varid{c},\Varid{d}{}\<[25]%
\>[25]{})\mathbin{:}\Varid{insere}\;(\Varid{a},\Varid{b})\;\Varid{e}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  fazer isto como catalist FIXME}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment psimulateGroupStage :: [[Match]] -> Dist [[Team]]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment groupWinners criteria = best 2 . consolidate . (>>= matchResult criteria)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment pgsCriteria :: Match -> Dist (Maybe Team)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment groupWinners :: (Match -> Maybe Team) -> [Match] -> [Team]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment groupWinners criteria = best 2 . consolidate . (>>= matchResult criteria)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pgroupWinners}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment pgroupWinners :: (Match -> Dist (Maybe Team)) -> [Match] -> Dist [Team]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment pgroupWinners pcriteria l = do }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     r <- mmap (pmatchResult pcriteria) l}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     x <- fmap (best 2 . consolidate' ) (concat r)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment     return x}{}\<[E]%
\\
