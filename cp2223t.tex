...
\xymatrix@C=3cm @R=2cm{
  A^*\ar[r]^{\ensuremath{\Varid{out}}}\ar[d]_{ana} & A+A\times{A^*}\ar[r]^{id+\ensuremath{\Varid{half}\comp \Varid{cons}}} & A+A^*\times{A^*} \ar[d]^{id + pura^2} \\
...
\begin{eqnarray}
\xymatrix@C=3cm @R=2cm{
  (S^*)^*\ar[r]^{\ensuremath{\Varid{out}}}\ar[d]_{paret} & 1+S^*\times(S^*)^*\ar[d]^{id + id \times{paret}} \\
