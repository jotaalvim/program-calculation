...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment splitp (a,l) = (a,groupBy (const ((> gamma) . ce)) l)}{}\<[E]%
\\
...
\>[B]{}\theta \mathrel{=}(\sequ \Varid{await})\comp (\Varid{drawSq}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{theta2}\;\Varid{l}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{await}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{drawSq}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{return}\;(){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{consb}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{present2}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Conid{Square}\mskip1.5mu]\mskip1.5mu]\to \fun{IO}\;(){}\<[E]%
\\
\>[B]{}\Varid{present2}\mathrel{=}\llparenthesis\, \alt{\Varid{return}}{\theta \comp \p1}\,\rrparenthesis{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment present = cataList $ either return ( consb . ( theta >< id ) )}{}\<[E]%
\\
\>[B]{}\Varid{present}\mathrel{=}\bot \mbox{\onelinecomment  cataList $ either return ( consb . ( theta >< id ) )}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsection*{Problema 4}
\subsubsection*{Versão não probabilística}
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment   FIXME}{}\<[E]%
\\
\>[B]{}\Varid{pairup}{}\<[9]%
\>[9]{}\mathrel{=}\llparenthesis\, \cdot \,\rrparenthesis\mathbin{\$}\alt{\Varid{nil}}{\Varid{id}}\comp (\Varid{id}+(\mathsf{conc}\comp \conj{\uncurry{\beta }\comp (\Varid{id}\times(\map \;\p1))}{\Varid{id}})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{vs}\;\Varid{x}\mid \Varid{x}\equiv \Varid{a}\mathrel{=}[\mskip1.5mu (\Varid{a},\mathrm{3}),(\Varid{b},\mathrm{0})\mskip1.5mu]{}\<[E]%
\\
\>[9]{}\hsindent{5}{}\<[14]%
\>[14]{}\mid \Varid{x}\equiv \Varid{b}\mathrel{=}[\mskip1.5mu (\Varid{a},\mathrm{0}),(\Varid{b},\mathrm{3})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Pensamos logo em usar o  gene do ana do mergesort, lsplit que parte uma lista em 2 mas não funciona porque queremos manter a mesma ordem relativa entre os elementos quando parte}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment half l = splitAt (div 2 (length l)) l}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment half = uncurry splitAt . split (flip div 2 . length) id}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment half = (>>=) (div 2 . length) splitAt}{}\<[E]%
\\
