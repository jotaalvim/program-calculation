...
Conseguimos reconhecer alguns o padãro recursimo id \ensuremath{\times} map f  e pudemos ver que a função árvores é um anamorfismo das
Rose tree.
...
\xymatrix@C=3cm @R=2cm{
  ...
  \ensuremath{\Conid{RoseT}\;\Conid{S}\;\Conid{S}} & S \times(\ensuremath{\Conid{Rose}\;\Conid{S}\;\Conid{S}}^*)\ar[l]^{ inR }
 }
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix@C=3cm @R=2cm{
  \ensuremath{\Conid{N}}\ar[r]^{outNat}\ar[d]_{\ensuremath{\Varid{carpets}}} & 1+\ensuremath{\Conid{N}}\ar[r]^{id +\ensuremath{\conj{\eta }{\Varid{id}}}} & 1 + S^* \times{\ensuremath{\Conid{N}}}\ar[d]^{id +id \times{\ensuremath{\Varid{carpets}}^*}} \\
...
\begin{eqnarray*}
\xymatrix@C=3cm @R=2cm{
  (K^*)^*\ar[r]^{outListas}\ar[d]_{\ensuremath{\Varid{present2}}} & 1+K^*\times{(K)^*}\ar[d]^{id +id \times{\ensuremath{\Varid{present2}}}} \\
...
\ColumnHook
\end{hscode}\resethooks
Esta função fica mais elegante do que a devolver IO[()], mas não funciona porque como o haskell é preguiçoso quando faço p1 ele não vai
calcular o resultado da cauda assim se pedir para imprimir vários níves ele só imprime o último.

Chegamos a conclusão que por isso é que precisamos do IO[()], para de alguma forma juntar a cabeça com a cauda
já calculada

Adaptamos a função para que passe a encaixar IO() da função theta o tipo IO[()] que vem da parte recursiva da
cauda do catamorfismo para isso usamos a função consb$\flat$.
...
\>[B]{}\Varid{present2}\mathrel{=}\llparenthesis\, \alt{\Varid{return}}{\theta \comp \p1}\,\rrparenthesis{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{theta2}\mathrel{=}(\sequ \Varid{return}\;[\mskip1.5mu ()\mskip1.5mu])\comp (\sequ \Varid{await})\comp (\Varid{drawSq}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment present3 :: [[Square]] -> IO[()]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment present3 = cataList ( either (return [()]) (theta2 . p1) )}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{half}\mathrel{=}(\bind )\;(\mathrm{2}\div \cdot \comp \length )\;\Varid{splitAt}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{half}\mathrel{=}\Varid{splitAt}\rbind \mathrm{2}\div \cdot \comp \length {}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment matchResult :: (Match -> Maybe Team) -> Match -> [(Team, Int)]}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment pgroupWinners :: (Match -> Dist (Maybe Team)) -> [Match] -> Dist [Team]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment pgroupWinners pgsCriteria = (>>= matchResult )}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pgroupWinners}{}\<[20]%
\>[20]{}\mathrel{=}\bot {}\<[E]%
\\
\>[B]{}\Varid{pinitKnockoutStage}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pmatchResult}{}\<[20]%
\>[20]{}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
