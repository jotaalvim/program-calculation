...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{swapTeams}\;[\mskip1.5mu [\mskip1.5mu a_1 ,a_2 \mskip1.5mu],[\mskip1.5mu b_1 ,b_2 \mskip1.5mu],[\mskip1.5mu c_1 ,c_2 \mskip1.5mu],[\mskip1.5mu d_1 ,d_2 \mskip1.5mu]\mskip1.5mu]\mathrel{=}[\mskip1.5mu a_1 ,b_2 ,c_1 ,d_2 ,b_1 ,a_2 ,d_1 ,c_2 \mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{psimulateGroupStage}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Conid{Match}\mskip1.5mu]\mskip1.5mu]\to \fun{Dist}\;[\mskip1.5mu [\mskip1.5mu \Conid{Team}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{fa}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{fa}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{1}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{fa}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{2}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{fa}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{3})\mathrel{=}\Varid{a}\mathbin{*}(\Varid{fa}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{2}))\mathbin{+}\Varid{b}\mathbin{*}(\Varid{fa}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1}))\mathbin{+}\Varid{c}\mathbin{*}(\Varid{fa}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{initial}\mathrel{=}((\mathrm{1},\mathrm{1}),\mathrm{0}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;((\Varid{x},\Varid{y}),\Varid{z})\mathrel{=}((\Varid{a}\mathbin{*}\Varid{x}\mathbin{+}\Varid{b}\mathbin{*}\Varid{y}\mathbin{+}\Varid{c}\mathbin{*}\Varid{z},\Varid{x}),\Varid{y}){}\<[E]%
\\[\blanklineskip]%
...
\begin{cases}
      \begin{cases}
        \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}}\\
        \ensuremath{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{a}\mathbin{*}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathbin{+}\Varid{b}\mathbin{*}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}\mathbin{+}\Varid{c}\mathbin{*}\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}\\
      \begin{cases}
        \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}}\\  
        \ensuremath{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{f}\;\Varid{n}}
      \end{cases}\\
      \begin{cases}
        \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\mathrm{0}\mathrel{=}\mathrm{1}}\\
        \ensuremath{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{g}\;\Varid{n}}
      \end{cases}
\end{cases}

\just\equiv{(75)\ensuremath{\times}6 , def succ, def a*, def b*, def c*, (73)\ensuremath{\times}9,(77)\ensuremath{\times}2}

\begin{cases}
      \begin{cases}
        \ensuremath{((\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}})\;\Varid{n}\mathrel{=}\underline{\mathrm{1}}\;\Varid{n}}\\
        \ensuremath{((\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ )\;\Varid{n}\mathrel{=}\Varid{add}\comp \conj{\Varid{add}\comp \conj{(\Varid{a}\mathbin{*})\comp (\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})}{(\Varid{b}\mathbin{*})\comp (\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})}}{(\Varid{c}\mathbin{*})\;(\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c})}\;\Varid{n}}
      \end{cases}\\
      \begin{cases}
       \ensuremath{((\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}})\;\Varid{n}\mathrel{=}\underline{\mathrm{1}}\;\Varid{n}}\\  
       \ensuremath{((\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ )\;\Varid{n}\mathrel{=}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}\\
      \begin{cases}
       \ensuremath{((\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}})\;\Varid{n}\mathrel{=}\underline{\mathrm{0}}\;\Varid{n}}\\  
       \ensuremath{((\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ )\;\Varid{n}\mathrel{=}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}
\end{cases}

\just\equiv{(72)\ensuremath{\times}6,(11)\ensuremath{\times}2}

\begin{cases}
      \begin{cases}
        \ensuremath{(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}} \\
        \ensuremath{(\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ \mathrel{=}\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))\comp \conj{\conj{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}
      \end{cases}\\
      \begin{cases}
       \ensuremath{(\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{1}}}\\  
       \ensuremath{(\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ \mathrel{=}\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}\\
      \begin{cases}
       \ensuremath{(\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{0}}}\\  
       \ensuremath{(\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c})\comp \succ \mathrel{=}\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{n}}
      \end{cases}
\end{cases}

\just\equiv{def-in,(18)\ensuremath{\times}6, f a b c = j, g a b c = l, h a b c = p}

\begin{cases}
  \begin{cases}
    \ensuremath{\Varid{j}\comp \mathbf{in}\comp i_1\mathrel{=}\underline{\mathrm{1}}}\\
    \ensuremath{\Varid{j}\comp \mathbf{in}\comp i_2\mathrel{=}\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))\comp \conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}
  \end{cases}\\
  \begin{cases}
   \ensuremath{\Varid{l}\comp \mathbf{in}\comp i_1\mathrel{=}\underline{\mathrm{1}}}\\  
   \ensuremath{\Varid{l}\comp \mathbf{in}\comp i_2\mathrel{=}\Varid{j}}
  \end{cases}\\
  \begin{cases}
   \ensuremath{\Varid{p}\comp \mathbf{in}\comp i_1\mathrel{=}\underline{\mathrm{0}}}\\  
   \ensuremath{\Varid{p}\comp \mathbf{in}\comp i_2\mathrel{=}\Varid{l}}
  \end{cases}
\end{cases}

\just\equiv{(18)\ensuremath{\times}3}

\begin{cases}
  \ensuremath{\Varid{j}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))\comp \conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}}\\
  \ensuremath{\Varid{l}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{j}}}\\
  \ensuremath{\Varid{p}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{l}}}
\end{cases}

\just\equiv{(1), (22), (7)\ensuremath{\times}4}

\begin{cases}
  \ensuremath{\Varid{j}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))}\comp (\mathrm{1}\mathbin{+}\conj{(\conj{\Varid{j}}{\Varid{l}})}{\Varid{p}})}\\
  \ensuremath{\Varid{l}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\p1\comp \p1\comp \conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}}\\
  \ensuremath{\Varid{p}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\p2\comp \p1\comp \conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}}
\end{cases}
\just\equiv{(1)\ensuremath{\times}, (22)\ensuremath{\times}2, (1+(split (split (j)(l)) (p))) = F(split (split (j)(l)) (p)) }
\begin{cases}
  \ensuremath{\mbox{\onelinecomment }}\\
  \ensuremath{\Varid{j}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\p1\comp \p1}\comp \Conid{F}\;\conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}\\
  \ensuremath{\Varid{p}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\p2\comp \p1}\comp \Conid{F}\;\conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}
\end{cases}

\just\equiv{(16), (9)\ensuremath{\times}2}

\begin{cases}
  \ensuremath{\conj{\Varid{j}}{\Varid{l}}\comp \mathbf{in}\mathrel{=}\conj{\alt{\underline{\mathrm{1}}}{\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})}}{\cdot }}><\ensuremath{(\Varid{b}\mathbin{*}))}><\ensuremath{(\Varid{c}\mathbin{*}))))\;(\alt{\underline{\mathrm{1}}}{\p1\comp \p1}))\comp \Conid{F}\;\conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}\\
  \ensuremath{\Varid{p}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\p2\comp \p1}\comp \Conid{F}\;\conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}
\end{cases}
...
begin{cases}
  \ensuremath{\conj{\Varid{j}}{\Varid{l}}\comp \mathbf{in}\mathrel{=}\alt{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\conj{\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})}{\cdot }}}><\ensuremath{(\Varid{b}\mathbin{*}))}><\ensuremath{(\Varid{c}\mathbin{*})))\;(\p1\comp \p1)))\comp \Conid{F}\;\conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}\\
  \ensuremath{\Varid{p}\comp \mathbf{in}\mathrel{=}\alt{\underline{\mathrm{0}}}{\p2\comp \p1}\comp \Conid{F}\;\conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}}
\end{cases}

\just\equiv{(53)}

\ensuremath{\conj{\conj{\Varid{j}}{\Varid{l}}}{\Varid{p}}\mathrel{=}\llparenthesis\, (\alt{(\conj{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\underline{\cdot }}\;\mathrm{0})}{\conj{\conj{\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))}{\p1\comp \p1}}{\p2}\comp \p1})\,\rrparenthesis}

\just\equiv{j=f a b c, l=g a b c, p = h a b c}

\ensuremath{\conj{\conj{\Varid{f}\;\Varid{a}\;\Varid{b}\;\Varid{c}}{\Varid{g}\;\Varid{a}\;\Varid{b}\;\Varid{c}}}{\Varid{h}\;\Varid{a}\;\Varid{b}\;\Varid{c}}\mathrel{=}\llparenthesis\, \alt{\conj{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\underline{\mathrm{0}}}}{\conj{\conj{\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*}))\times(\Varid{c}\mathbin{*}))}{\p1\comp \p1}}{\p2}\comp \p1}\,\rrparenthesis}


\ensuremath{\conj{\conj{\underline{\mathrm{1}}}{\underline{\mathrm{1}}}}{\underline{\mathrm{0}}}\mathrel{=}\underline{(\mathrm{1},\mathrm{1}),\mathrm{0}}}

 \just\equiv{(72),(71)\times{2},(75)\ensuremath{\times}4}

 ((1,1),0) = ((1,1),0)

 \begin{bquote}
 \ensuremath{\Conid{Logo}\mathbin{:}\Varid{initial}\mathrel{=}((\mathrm{1},\mathrm{1}),\mathrm{0})}

 \ensuremath{\Varid{loop}\;\Varid{a}\;\Varid{b}\;\Varid{c}\mathrel{=}\conj{\conj{\Varid{add}\comp (\Varid{add}\comp ((\Varid{a}\mathbin{*})\times(\Varid{b}\mathbin{*})))\times(\Varid{c}\mathbin{*})}{\p1\comp \p1}}{\p2\comp \p1}}
 \end{bquote}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{arvore}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}\Conid{Var}\;\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{arvore}\;\Varid{l}{}\<[12]%
\>[12]{}\mathrel{=}\Conid{Term}\;(\Conid{Var}\;\Varid{a})\;\Varid{filhos}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Varid{a},\Varid{b}){}\<[18]%
\>[18]{}\mathrel{=}\Varid{splitp}\;\Varid{l}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{filhos}\mathrel{=}[\mskip1.5mu \Varid{arvore}\;\Varid{f}\;\Varid{p}\;\Varid{f}\leftarrow \Varid{b}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{splitp}\;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}(\Varid{a},\Varid{groupBy}\;(\mathbin{\char92 \char95 }\Varid{y}\to \Varid{ce}\;\Varid{y}\mathbin{>}\gamma )\;{}\<[54]%
\>[54]{}\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\gamma {}\<[18]%
\>[18]{}\mathrel{=}\Varid{ce}\;\Varid{a}\mathbin{+}\mathrm{4}\mbox{\onelinecomment  indentação do pai + 4}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{arvore}\mathrel{=}\uncurry{\Conid{Term}}\comp (\Conid{Var}\times(\map \;\Varid{arvore}))\comp \Varid{splitp}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\vspace{0.5cm}

Apos isso, conseguimos reconhecer alguns o o Functor das Rose Trees (\textit{id \ensuremath{\times} map f}) e pudemos ver que a função \textit{arvores} é um anamorfismo das
\ensuremath{\Conid{Rose}\;\Conid{Tree}}.
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{splitp}\;(\Varid{a},\Varid{l})\mathrel{=}(\Varid{a},\Varid{groupBy}\;\underline{(\mathbin{>}\gamma )\comp \Varid{ce}}\;\Varid{l}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\gamma {}\<[16]%
\>[16]{}\mathrel{=}\Varid{ce}\;\Varid{a}\mathbin{+}\mathrm{4}\mbox{\onelinecomment  indentação do pai + 4}{}\<[E]%
\\[\blanklineskip]%
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{ce}\mathrel{=}\Varid{anaNat}\;\psi \mbox{\onelinecomment  conta espaços}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\psi \;(\text{\ttfamily '~'}\mathbin{:}\Varid{t})\mathrel{=}i_2\;\Varid{t}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\psi \;\anonymous \mathrel{=}i_1\;(){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gene}\mathrel{=}(\Varid{id}+\Varid{splitp})\comp \Varid{out}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

Função de pós-processamento:
    Começamos por tentar escrever a função \ensuremath{\Varid{post}} com um catamorfismo de \ensuremath{\Conid{Exp}}.
\begin{eqnarray*}
\xymatrix @C=3cm @R=1.5cm{
  \ensuremath{\Conid{Exp}\;\Conid{S}\;\Conid{S}}\ar[d]_{post}\ar[r]^(0.45){out} & S + S \times (\ensuremath{\Conid{Exp}\;\Conid{S}\;\Conid{S}})^*\ar[d]^{id + id \times{post^*}}\\
  (S^*)^*   & S + S \times ((S^*)^*)^*\ar[d]^{id + id \times{concat^*}} \\
            & S + S \times (S^*)^*\ar[d]^{id + mete} \\
            & S + (S^*)^*\ar[uul]^{[\ensuremath{\Varid{singl}\comp \Varid{singl}} , id]}
 }
\end{eqnarray*}

Temos que o gene da função \ensuremath{\Varid{post}} é dado por:

\begin{eqnarray*}
\start
     \ensuremath{\Varid{gpost}\mathrel{=}\alt{\Varid{singl}\comp \Varid{singl}}{\Varid{id}}\comp (\Varid{id}\mathbin{+}\Varid{mete})\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{concat})}
%
\just\equiv{ (22), (1) x 2 }
%
     \ensuremath{\Varid{gpost}\mathrel{=}\alt{\Varid{singl}\comp \Varid{singl}}{\Varid{mete}}\comp (\Varid{id}\mathbin{+}\Varid{id}\times\Varid{concat})}
%
\just\equiv{ (22), (1) x 2 }
%
     \ensuremath{\Varid{gpost}\mathrel{=}\alt{\Varid{singl}\comp \Varid{singl}}{\Varid{mete}\comp \Varid{id}\times\Varid{concat}}}
\qed
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mete}\;(\Varid{a},\Varid{b})\mathrel{=}[\mskip1.5mu \Varid{a}\mskip1.5mu]\mathbin{:}\map \;(\Varid{a}\mathbin{:})\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gpost}\mathrel{=}\alt{\Varid{singl}\comp \Varid{singl}}{\Varid{mete}\comp (\Varid{id}\times\Varid{concat})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{post}\mathrel{=}\llparenthesis\, \Varid{gpost}\,\rrparenthesis_\textit{\tiny Exp}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{post}\mathrel{=}\Varid{tail}\comp \Varid{prefixes}\comp \Varid{nodes}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=3cm @R=2cm{
  ...
  \ensuremath{\Conid{RoseT}\;\Conid{S}\;\Conid{S}} & S \times(\ensuremath{\Conid{Rose}\;\Conid{S}\;\Conid{S}}^*)\ar[l]^{ in_{R} }
 }
\end{eqnarray*}
...
\column{28}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{quadrado2}\;(((\Varid{x},\Varid{y}),\Varid{l}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{n}\equiv \mathrm{0}\mathrel{=}(\Varid{meio},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{n}{}\<[10]%
\>[10]{}\mathbin{>}\mathrm{0}\mathrel{=}(\Varid{meio},{}\<[24]%
\>[24]{}[\mskip1.5mu {}\<[24E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(((\Varid{x}{}\<[20]%
\>[20]{},\Varid{y}){}\<[27]%
\>[27]{},\Varid{t}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\Varid{t}{}\<[21]%
\>[21]{},\Varid{y}){}\<[28]%
\>[28]{},\Varid{t}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(((\Varid{x}{}\<[21]%
\>[21]{},\Varid{y}\mathbin{+}\Varid{t}){}\<[28]%
\>[28]{},\Varid{t}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(((\Varid{x}{}\<[21]%
\>[21]{},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{t}),\Varid{t}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\Varid{t}{}\<[21]%
\>[21]{},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{t}),\Varid{t}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{t},\Varid{y}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{t}),\Varid{t}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{t},\Varid{y}){}\<[28]%
\>[28]{},\Varid{t}),\Varid{n}\mathbin{-}\mathrm{1}),{}\<[E]%
\\
\>[10]{}\hsindent{3}{}\<[13]%
\>[13]{}(((\Varid{x}\mathbin{+}\mathrm{2}\mathbin{*}\Varid{t},\Varid{y}\mathbin{+}\Varid{t}){}\<[28]%
\>[28]{},\Varid{t}),\Varid{n}\mathbin{-}\mathrm{1})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{t}{}\<[14]%
\>[14]{}\mathrel{=}\Varid{l}\mathbin{/}\mathrm{3}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{meio}\mathrel{=}((\Varid{x}\mathbin{+}\Varid{t},\Varid{y}\mathbin{+}\Varid{t}),\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\beta \mathrel{=}\map \comp \Varid{flip}\;\overline{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\beta \;\text{\ttfamily \char34 asd\char34}\;[\mskip1.5mu \mathrm{1}\mathinner{\ldotp\ldotp}\mathrm{5}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}[\mskip1.5mu (\mathrm{1},\text{\ttfamily \char34 asd\char34}),(\mathrm{2},\text{\ttfamily \char34 asd\char34}),(\mathrm{3},\text{\ttfamily \char34 asd\char34}),(\mathrm{4},\text{\ttfamily \char34 asd\char34}),(\mathrm{5},\text{\ttfamily \char34 asd\char34})\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{81E}{@{}l@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{quadrado}\;(((\Varid{x},\Varid{y}),\Varid{l}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{n}\equiv \mathrm{0}\mathrel{=}(\Varid{meio},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{n}{}\<[10]%
\>[10]{}\mathbin{>}\mathrm{0}\mathrel{=}(\Varid{meio},\beta \;(\Varid{n}\mathbin{-}\mathrm{1})\mathbin{\$}\beta \;\Varid{t}\mathbin{\$}\beta \;\Varid{y}\;\Varid{k}\mathbin{+\!\!\!+}\beta \;\Varid{b}\;\Varid{k}\mathbin{+\!\!\!+}\beta \;\Varid{c}\;(\Varid{init}\;\Varid{k}){}\<[81]%
\>[81]{}){}\<[81E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{t}{}\<[14]%
...
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{meio}\mathrel{=}((\Varid{x}\mathbin{+}\Varid{t},\Varid{c}),\Varid{t}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{fun}\mathrel{=}[\mskip1.5mu (\mathbin{+}(\mathrm{2}\mathbin{*}\Varid{t})),(\mathbin{+}\Varid{t})\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{k}\mathrel{=}\Varid{x}\mathbin{:}\map \;(\mathbin{\$}\Varid{x})\;\Varid{fun}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}[\mskip1.5mu \Varid{b},\Varid{c}\mskip1.5mu]\mathrel{=}\map \;(\mathbin{\$}\Varid{y})\;\Varid{fun}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{gsq}{}\<[6]%
\>[6]{}\mathrel{=}\Varid{quadrado}{}\<[E]%
\\[\blanklineskip]%
...
\begin{eqnarray*}
\xymatrix@C=3cm @R=2cm{
  \ensuremath{\Conid{Rose}\;\Conid{A}}\ar[r]^{out}\ar[d]_{\ensuremath{\Conid{Rose2List}}} & A \times{(\ensuremath{\Conid{Rose}\;\Conid{A}})^*)}\ar[d]^{id \times{\ensuremath{\Conid{Rose2List}}^*}} \\
...
\begin{eqnarray*}
\xymatrix@C=3cm @R=2cm{
  \mathbb{N}\ar[r]^{out_{Nat}}\ar[d]_{\ensuremath{\Varid{carpets}}} & 1+\mathbb{N}\ar[r]^{id +\ensuremath{\conj{\eta }{\Varid{id}}}} & 1 + S^* \times{\mathbb{N}}\ar[d]^{id +id \times{\ensuremath{\Varid{carpets}}^*}} \\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\eta \mathrel{=}\Varid{sierpinski}\comp \overline{\Varid{id}}\;((\mathrm{0},\mathrm{0}),\mathrm{32}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{carpets}\mathrel{=}\anaList{(\Varid{id}+\conj{\eta }{\Varid{id}})\comp \Varid{outNat}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\theta \;\Varid{l}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{drawSq}\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{await}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{present}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\theta \;\Varid{h}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{return}\;[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=3cm @R=2cm{
  (K^*)^*\ar[r]^{out_{Listas}}\ar[d]_{\ensuremath{\Varid{present2}}} & 1+K^*\times{(K)^*}\ar[d]^{id +id \times{\ensuremath{\Varid{present2}}}} \\
  IO() & 1+K^* \times{IO()}\ar[l]^{ [\ensuremath{\Varid{return}} , \ensuremath{\theta \comp \p1}]} 
 }
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\theta \mathrel{=}(\sequ \Varid{await})\comp (\Varid{drawSq}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{present2}\mathbin{::}[\mskip1.5mu \Conid{Square}\mskip1.5mu]\to \fun{IO}\;(){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{present2}\mathrel{=}\llparenthesis\, \alt{\Varid{return}}{\theta \comp \p1}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray}
\xymatrix@C=3cm @R=2cm{
  (S^*)^*\ar[r]^{\ensuremath{\Varid{out}}}\ar[d]_{present} & 1+S^*\times(S^*)^*\ar[d]^{id + id \times{present}} \\
...
\begin{eqnarray*}
\start
     \ensuremath{\Varid{gene}\mathrel{=}\alt{\Varid{return}\comp \Varid{return}}{\Varid{id}}\comp (\Varid{id}\mathbin{+}cons\flat )\comp (\Varid{id}\mathbin{+}\theta \times\Varid{id})}
%
\just\equiv{ (22), (1) x 2 }
%
     \ensuremath{\Varid{gene}\mathrel{=}\alt{\Varid{return}\comp \Varid{return}}{cons\flat \comp (\theta \times\Varid{id})}}
\end{eqnarray*}
...
\>[B]{}\theta \mathrel{=}(\sequ \Varid{await})\comp (\Varid{drawSq}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{present}\mathrel{=}\llparenthesis\, \alt{\Varid{return}\comp \Varid{return}}{cons\flat \comp (\theta \times\Varid{id})}\,\rrparenthesis\comp \Varid{reverse}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}cons\flat \;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{x}\leftarrow \Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{y}\leftarrow \Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{return}\mathbin{\$}\Varid{cons}\;(\Varid{x},\Varid{y}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=3cm @R=2cm{
  (A\times{A})^*\ar[r]^{out}\ar[d]_{} & 1 + A \times{(A\times{A})^*}\ar[d]^{id + id \times{\ensuremath{\Varid{consolidate}}}} \\
  A\times{A^*} & 1+A\times{(A\times{A})^*}\ar[d]^{ id + (\ensuremath{\uncurry{\Varid{insere}}}) } \\
               & 1 +(A\times{A})^*\ar[ul]^{[\ensuremath{\Varid{nill}} , id]}
 }
\end{eqnarray*}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cgene}\mathrel{=}\alt{\Varid{nil}}{\Varid{id}}\comp (\Varid{id}+\uncurry{\Varid{insere}}){}\<[E]%
\\
\>[B]{}\Varid{insere2}\mathrel{=}\llparenthesis\, \alt{\Varid{nil}}{\Varid{id}+\uncurry{\Varid{i}}}\,\rrparenthesis{}\<[E]%
\\
\>[B]{}\Varid{i}\;\Varid{a}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}(\Varid{a},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{i}\;(\Varid{a},\Varid{b})\;((\Varid{c},\Varid{d})\mathbin{:}\Varid{e}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{a}\equiv \Varid{c}\mathrel{=}((\Varid{a},\Varid{b}\mathbin{+}\Varid{d}),\Varid{e}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{a}\not\equiv \Varid{c}\mathrel{=}((\Varid{c},\Varid{d}),\Varid{e}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\start
     \ensuremath{\Varid{cgene}\mathrel{=}\alt{\Varid{nil}}{\Varid{id}}\comp \Varid{id}\mathbin{+}\uncurry{\Varid{insere}}}
%
\just\equiv{ (22); (1)x2  }
%
     \ensuremath{\Varid{cgene}\mathrel{=}\alt{\Varid{nil}}{\uncurry{\Varid{insere}}}}
\qed
\end{eqnarray*}
...
\column{22}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{insere}\;\Varid{a}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{insere}\;(\Varid{a},\Varid{b})\;((\Varid{c},\Varid{d})\mathbin{:}\Varid{e}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{a}\equiv \Varid{c}\mathrel{=}(\Varid{a},\Varid{b}\mathbin{+}\Varid{d})\mathbin{:}\Varid{e}\mbox{\onelinecomment  insere (a,b) e }{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mid \Varid{a}\not\equiv \Varid{c}\mathrel{=}(\Varid{c},\Varid{d}{}\<[22]%
\>[22]{})\mathbin{:}\Varid{insere}\;(\Varid{a},\Varid{b})\;\Varid{e}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cgene}\mathrel{=}\alt{\Varid{nil}}{\uncurry{\Varid{insere}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{pairup}\;(\Varid{a}\mathbin{:}\Varid{l})\mathrel{=}\beta \;\Varid{a}\;\Varid{l}\mathbin{+\!\!\!+}\Varid{pairup}\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pontos}\;(\Varid{a},\Varid{b}){}\<[17]%
\>[17]{}\mathrel{=}\Varid{maybe}\;[\mskip1.5mu (\Varid{a},\mathrm{1}),(\Varid{b},\mathrm{1})\mskip1.5mu]\;\Varid{vs}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{vs}\;\Varid{x}\mid \Varid{x}\equiv \Varid{a}\mathrel{=}[\mskip1.5mu (\Varid{a},\mathrm{3}),(\Varid{b},\mathrm{0})\mskip1.5mu]{}\<[E]%
\\
\>[5]{}\hsindent{5}{}\<[10]%
\>[10]{}\mid \Varid{x}\equiv \Varid{b}\mathrel{=}[\mskip1.5mu (\Varid{a},\mathrm{0}),(\Varid{b},\mathrm{3})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{matchResult}\;\Varid{f}\;\Varid{m}\mathrel{=}\Varid{pontos}\;\Varid{m}\mathbin{\$}\Varid{f}\;\Varid{m}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{half}\mathrel{=}\uncurry{\Varid{splitAt}}\comp \conj{\Varid{flip}\;\cdot \div \cdot \;\mathrm{2}\comp \length }{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{half}\mathrel{=}\Varid{splitAt}\rbind \Varid{flip}\;\cdot \div \cdot \;\mathrm{2}\comp \length {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=3cm @R=2cm{
  A^*\ar[r]^{\ensuremath{\Varid{out}}}\ar[d]_{ ana } & A+A\times{A^*}\ar[r]^{id+\ensuremath{\Varid{half}\comp \Varid{cons}}} & A+A^*\times{A^*} \ar[d]^{id + ana^2} \\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{glt}\mathrel{=}(\Varid{id}+\Varid{half}\comp \Varid{cons})\comp \Varid{out}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\subsubsection*{Versão probabilística}
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pmatchResult}\;\Varid{criteria}\;\Varid{m}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{e}\leftarrow \Varid{criteria}\;\Varid{m}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{return}\mathbin{\$}\Varid{pontos}\;\Varid{m}\;\Varid{e}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pgroupWinners}\;\Varid{pcriteria}\;\Varid{l}\mathrel{=}\mathsf{fmap}\;(\Varid{best}\;\mathrm{2}\comp \Varid{consolidate'}\comp \Varid{concat})\mathbin{\$}\Varid{mmap}\;(\Varid{pmatchResult}\;\Varid{pcriteria})\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
